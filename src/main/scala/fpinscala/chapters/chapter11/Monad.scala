package fpinscala.chapters.chapter11

import fpinscala.chapters.chapter6.State
import fpinscala.chapters.chapter7.Par
import fpinscala.chapters.chapter7.Par.Par
import fpinscala.testing.Gen

/**
  * Created by seung on 2017/09/16.
  */
trait Functor[F[_]] {
...
object Monad {
  ...
  def parseMonad[P[+ _]](p: Parsers[P]) = new Monad[P] {
