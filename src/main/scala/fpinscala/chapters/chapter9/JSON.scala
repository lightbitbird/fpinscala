package fpinscala.chapters.chapter9
...
"""
  ...
  val P = fpinscala.chapters.chapter9.instances.Reference

  import fpinscala.chapters.chapter9.instances.ReferenceTypes.Parser
